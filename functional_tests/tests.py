...
class VisitorTest(LiveServerTestCase):
    ...
    def test_show_main_and_add_item(self):
        ...
        self.assertIn('현재 사용금액: 0원', present_box.find_element_by_id("total_sum"))
        self.assertIn('남은 금액: 300000원', present_box.find_element_by_id("residual"))
        
        # (각 항목별 사용가능금액이 표시된다.)  -- 이부분 나중에 


        #메뉴에서 항목추가를 눌러 항목 추가로 이동한다.   -- 일단 하이퍼링크로 대체
        self.browser.click("add_item")
